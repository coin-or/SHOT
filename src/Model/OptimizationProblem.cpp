...
void OptimizationProblem::updateVariables()
{
...
void OptimizationProblem::updateFactorableFunctions()
{
...
void OptimizationProblem::add(Variables variables)
{
    for (auto V : variables)
        add(V);
}

void OptimizationProblem::add(VariablePtr variable)
{
...
void OptimizationProblem::add(LinearConstraintPtr constraint)
{
...
void OptimizationProblem::add(QuadraticConstraintPtr constraint)
{
    numericConstraints.push_back(std::dynamic_pointer_cast<NumericConstraint>(constraint));
...
void OptimizationProblem::add(NonlinearConstraintPtr constraint)
{
    numericConstraints.push_back(std::dynamic_pointer_cast<NumericConstraint>(constraint));
...
void OptimizationProblem::add(ObjectiveFunctionPtr objective)
{
...
template <class T>
void OptimizationProblem::add(std::vector<T> elements)
{
    for (auto E : elements)
    {
        add(E);
...
double OptimizationProblem::getVariableLowerBound(int variableIndex)
{
    return allVariables.at(variableIndex)->lowerBound;
};

double OptimizationProblem::getVariableUpperBound(int variableIndex)
{
    return allVariables.at(variableIndex)->upperBound;
};

VectorDouble OptimizationProblem::getVariableLowerBounds()
{
    if (!variablesUpdated)
    {
        updateVariables();
...
VectorDouble OptimizationProblem::getVariableUpperBounds()
{
    if (!variablesUpdated)
    {
        updateVariables();
...
void OptimizationProblem::setVariableLowerBound(int variableIndex, double bound)
{
    allVariables.at(variableIndex)->lowerBound = bound;
    variablesUpdated = true;
};

void OptimizationProblem::setVariableUpperBound(int variableIndex, double bound)
{
    allVariables.at(variableIndex)->upperBound = bound;
    variablesUpdated = true;
};

void OptimizationProblem::setVariableBounds(int variableIndex, double lowerBound, double upperBound)
{
...
template <class T>
NumericConstraintValues OptimizationProblem::getAllDeviatingConstraints(const VectorDouble &point, double tolerance, std::vector<T> constraintSelection)
{
...
NumericConstraintValues OptimizationProblem::getAllDeviatingLinearConstraints(const VectorDouble &point, double tolerance)
{
    return getAllDeviatingConstraints(point, tolerance, linearConstraints);
};

NumericConstraintValues OptimizationProblem::getAllDeviatingQuadraticConstraints(const VectorDouble &point, double tolerance)
{
    return getAllDeviatingConstraints(point, tolerance, quadraticConstraints);
};

NumericConstraintValues OptimizationProblem::getAllDeviatingNonlinearConstraints(const VectorDouble &point, double tolerance)
{
    return getAllDeviatingConstraints(point, tolerance, nonlinearConstraints);
};

bool OptimizationProblem::areLinearConstraintsFulfilled(VectorDouble point, double tolerance)
{
    auto deviatingConstraints = getAllDeviatingLinearConstraints(point, tolerance);
    return (deviatingConstraints.size() == 0);
};

bool OptimizationProblem::areQuadraticConstraintsFulfilled(VectorDouble point, double tolerance)
{
    auto deviatingConstraints = getAllDeviatingQuadraticConstraints(point, tolerance);
    return (deviatingConstraints.size() == 0);
};

bool OptimizationProblem::areNonlinearConstraintsFulfilled(VectorDouble point, double tolerance)
{
    auto deviatingConstraints = getAllDeviatingNonlinearConstraints(point, tolerance);
    return (deviatingConstraints.size() == 0);
};

bool OptimizationProblem::areNumericConstraintsFulfilled(VectorDouble point, double tolerance)
{
    auto deviatingConstraints = getAllDeviatingNumericConstraints(point, tolerance);
    return (deviatingConstraints.size() == 0);
};

bool OptimizationProblem::areIntegralityConstraintsFulfilled(VectorDouble point, double tolerance)
{
...
bool OptimizationProblem::areVariableBoundsFulfilled(VectorDouble point, double tolerance)
{
...
std::ostream &operator<<(std::ostream &stream, const OptimizationProblem &problem)
{
