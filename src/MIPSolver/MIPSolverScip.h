...
class ScipCallbackMultiTree : public MIPSolverCallbackBase
{
public:
    ScipCallbackMultiTree(EnvironmentPtr envPtr);
...
class MIPSolverScip : public IMIPSolver, public MIPSolverBase
{
public:
    MIPSolverScip();
    MIPSolverScip(EnvironmentPtr envPtr);
    ~MIPSolverScip() override;
    ...
    SCIP* scip {nullptr};
    std::unique_ptr<ScipCallbackMultiTree> scipCallback;

    std::vector<SCIP_VAR*> vars;
    SCIP_CONS* lincons {nullptr};
