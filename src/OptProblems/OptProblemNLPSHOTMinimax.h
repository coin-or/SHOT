...
class OptProblemNLPSHOTMinimax: public OptProblem
{
	public:
		OptProblemNLPSHOTMinimax();
		~OptProblemNLPSHOTMinimax();
		...
		vector<IndexValuePair> getMostDeviatingConstraints(std::vector<double> point, double tolerance);
