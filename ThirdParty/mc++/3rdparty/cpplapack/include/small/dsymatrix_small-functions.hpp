...
/*!  */
template<long n>
inline double& dsymatrix_small<n>::operator()(const long& i, const long& j)
{VERBOSE_REPORT;
#ifdef  CPPL_DEBUG
  if(i<j){
    ERROR_REPORT;
...
/*!  */
template<long n>
inline double dsymatrix_small<n>::operator()(const long& i, const long& j) const
{VERBOSE_REPORT;
#ifdef  CPPL_DEBUG
  if(i<j){
    ERROR_REPORT;
...
/*!  */
template<long n>
inline dsymatrix_small<n>& dsymatrix_small<n>::set(const long& i, const long& j, const double& v)
{VERBOSE_REPORT;
  (*this)(i,j)=v;
  return *this;
}
