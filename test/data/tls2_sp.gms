...
*
*  Starting point p1 from MINLPLib (https://minlplib.org/tls2.p1.html)
*  Solution found by SBB with SNOPT as subsolver. Objective value: 5.3
...
* Starting point p1 from MINLPLib (https://minlplib.org/tls2.p1.html)
* Variables with value 0.0 are omitted (GAMS default)
b1.l = 1;
b2.l = 1;
i3.l = 16;
i4.l = 9;
