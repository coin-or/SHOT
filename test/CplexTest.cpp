...
int CplexTest(int argc, char* argv[])
{
    ...
    case 8:
        ...
        passed = CplexExternalDualBoundCallbackTest("data/fo7_2.osil", 20.7298, ES_TreeStrategy::MultiTree);
    ...
    case 9:
        ...
        passed = CplexExternalDualBoundCallbackTest("data/fo7_2.osil", 20.7298, ES_TreeStrategy::SingleTree);
